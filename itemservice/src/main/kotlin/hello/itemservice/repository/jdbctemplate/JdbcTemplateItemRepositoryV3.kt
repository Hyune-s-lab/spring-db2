 ...
 * SimpleJdbcInsert
 */
class JdbcTemplateItemRepositoryV3(dataSource: DataSource) : ItemRepository {
    private val log = LoggerFactory.getLogger(javaClass)

    private val template: NamedParameterJdbcTemplate
    private val jdbcInsert: SimpleJdbcInsert
    ...
    override fun save(item: Item): Item {
        ...
        val key: Number = jdbcInsert.executeAndReturnKey(param)
        item.id = key.toLong()
        return item
    }
    ...
    override fun findById(id: Long): Item? {
        ...
        return try {
            val param = Map.of<String, Any>("id", id)
